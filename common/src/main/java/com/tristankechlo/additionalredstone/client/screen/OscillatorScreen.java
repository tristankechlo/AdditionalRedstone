...
public class OscillatorScreen extends CustomScreen {
    ...
    private static final MutableComponent TICKS_ON = new TranslatableComponent("screen.additionalredstone.oscillator.ticks.on");
    private static final MutableComponent TICKS_OFF = new TranslatableComponent("screen.additionalredstone.oscillator.ticks.off");

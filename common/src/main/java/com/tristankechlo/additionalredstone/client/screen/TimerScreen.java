...
public class TimerScreen extends Screen {
    ...
    public void render(PoseStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(matrixStack, this.font,
                new TranslatableComponent("screen.additionalredstone.timer.description"), this.width / 2, 30, 0);

        GuiComponent.drawString(matrixStack, this.font,
                new TranslatableComponent("screen.additionalredstone.timer.power.on"), this.width / 2 - 130, 65, 0);
        GuiComponent.drawString(matrixStack, this.font,
                new TranslatableComponent("screen.additionalredstone.timer.power.off"), this.width / 2 - 130, 95, 0);
        GuiComponent.drawString(matrixStack, this.font,
                new TranslatableComponent("screen.additionalredstone.timer.interval"), this.width / 2 - 130, 125, 0);

...
public final class ModBlocks {
    ...
    public static final RegistryObject<Block> AND_GATE_BLOCK = BLOCKS.register("and_gate", () -> new ThreeInputLogicGate(GateLogic.AND));
    public static final RegistryObject<Block> NAND_GATE_BLOCK = BLOCKS.register("nand_gate", () -> new ThreeInputLogicGate(GateLogic.NAND));
    public static final RegistryObject<Block> OR_GATE_BLOCK = BLOCKS.register("or_gate", () -> new ThreeInputLogicGate(GateLogic.OR));
    public static final RegistryObject<Block> NOR_GATE_BLOCK = BLOCKS.register("nor_gate", () -> new ThreeInputLogicGate(GateLogic.NOR));
    public static final RegistryObject<Block> XOR_GATE_BLOCK = BLOCKS.register("xor_gate", () -> new ThreeInputLogicGate(GateLogic.XOR));
    public static final RegistryObject<Block> XNOR_GATE_BLOCK = BLOCKS.register("xnor_gate", () -> new ThreeInputLogicGate(GateLogic.XNOR));

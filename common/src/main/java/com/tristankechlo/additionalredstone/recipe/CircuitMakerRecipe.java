...
public class CircuitMakerRecipe implements Recipe<Container> {
    ...
    public abstract static class Serializer implements RecipeSerializer<CircuitMakerRecipe> {
        ...
        public CircuitMakerRecipe fromJson(ResourceLocation id, JsonObject json) {
            Ingredient input_1 = Ingredient.fromJson(GsonHelper.getAsJsonObject(json, "input_1"));
            Ingredient input_2 = Ingredient.fromJson(GsonHelper.getAsJsonObject(json, "input_2"));

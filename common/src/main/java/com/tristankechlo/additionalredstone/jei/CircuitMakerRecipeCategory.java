...
public class CircuitMakerRecipeCategory implements IRecipeCategory<CircuitMakerRecipe> {
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, CircuitMakerRecipe recipe, IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.OUTPUT, 84, 14).addItemStack(recipe.getResultItem());
    }
    ...
    public ResourceLocation getUid() {
        return JustEnoughItemsPlugin.RECIPE_TYPE.getUid();
    }

    @SuppressWarnings("removal")
    public Class<? extends CircuitMakerRecipe> getRecipeClass() {
        return JustEnoughItemsPlugin.RECIPE_TYPE.getRecipeClass();
    }
